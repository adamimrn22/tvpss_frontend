...
import PermohonanKrewDetailContent from "./PermohnanKrewDetailContent.jsx";
// import ViewAllKrewMohonContent from "./ViewAllKrewMohonContent.jsx";

const PermohonanKrewDetail = () => {
  ...
  return (
    <>
      <Box sx={{ display: "flex" }}>
        ...
        >
          <AdminNavbar />
          <AdminSubbarSecondary text="Permohonan Krew" />
          <PermohonanKrewDetailContent />
        </Stack>
      </Box>
...
export default PermohonanKrewDetail;
