...
// import AllUserContent from "./AllUserContent.jsx";
import AdminSubbarSecondary from "../components/Navbar/AdminSubbarSecondary.jsx";
import AlertSnackbar from "./AlertSnackbar.jsx";
import TVPSSDetailContent from "./TVPSSDetailsContent.jsx";

const StateTVPSSDetails = () => {
  ...
  return (
    <>
      <Box sx={{ display: "flex" }}>
        ...
        >
          <AdminNavbar />
          <AdminSubbarSecondary text="Info Status TVPSS" />
          {/* <AllUserContent /> */}
          <TVPSSDetailContent />
        </Stack>
      </Box>
...
export default StateTVPSSDetails;
