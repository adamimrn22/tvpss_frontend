  ...
  return (
    <>
      <Box sx={{ display: "flex" }}>
        ...
        >
          <AdminNavbar />
          <AdminSubbarSecondary text="Jana Sjil Pelajar" />
          <AllPermohonanContent />
        </Stack>
      </Box>
...
export default ViewAllPermohonan;
